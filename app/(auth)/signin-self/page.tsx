  ...
  return (
    <div className="flex flex-col items-center justify-center w-full">
      <div className="w-[672px] h-[602.34px] border rounded-xl bg-white flex flex-col items-center max-md:px-3 max-md:w-[408px]">
        <SignInHeader type="self" />
        <div className="flex flex-col gap-4 py-[24px] justify-center">
          {SignInItemsSelf.map((item, index) => (
            <Link key={index} href="/">
              <button className="flex gap-4 border-2 rounded-md w-[446px] h-[57.59px] justify-center items-center max-md:w-[376px] max-md:h-[57.59px]">
                <Image
                  src={item.icon}
                  alt="logo"
                  width={300}
